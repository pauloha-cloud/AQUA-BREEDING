...
const getCustomStorageBucket = () => {
  if (firebaseConfig.projectId === "aqua-breeding-platform-prod") {
    return "gs://aqua-breeding-prod-uploads";
  }
  return undefined; // uses default
};

export const storage = getStorage(app, getCustomStorageBucket());
